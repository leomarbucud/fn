...
--
-- Host: localhost
-- Generation Time: Jan 09, 2017 at 04:40 PM
...
INSERT INTO `hotels` (`hotel_id`, `hotel_name`, `hotel_details`, `date_created`) VALUES
(1, 'Hotel Transits', 'Address and ride a taxi', '2017-01-08 13:45:21'),
(2, '5 Star Hotel', '123456', '2017-01-08 14:31:40');
...
(7, 1, 'TEst', 3999.99, 2, '', 1, 'Hotel', NULL, 'Airplane', '2016-12-31', '2017-02-25', 43, 52, 2, '2016-12-11 21:13:13'),
...
(9, 1, 'Test', 1000, 1, 'Test', 1, '', 1, 'Bus', '2017-01-28', '2017-01-31', 1, 3, 1, '2017-01-08 14:25:49');
...
(9, 9, 8999.99, 4, 35999.96, 0, '0000-00-00'),
...
--
ALTER TABLE `rebook`
  MODIFY `rebook_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
