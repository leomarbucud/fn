...
--
-- Host: localhost
-- Generation Time: Oct 30, 2016 at 05:08 AM
...
(1, '1477235727_41e0f82a57b4880db8df0cd3fc8e3d13.jpg', 1),
(2, '1477235728_7fdc1a630c238af0815181f9faa190f5.jpg', 1),
(3, '1477235728_3fb2db6cccf4a23383383394b28b2b31.jpg', 1),
...
(1, 1, 'By 1 get 1 Free', 4999.99, 0, '2 days 1 night', 1, '', '', '2016-10-25 20:26:16'),
(2, 1, 'Boracay Vacation Package for 2016', 10000, 0, 'Boracay hotel/resort accommodation\r\nEXPRESS Roundtrip Transfers Airport to Boracay Resorts - Station 1, 2, 3 (All Inclusive)\r\nExtension nights allowed', 1, '', '', '2016-10-25 21:24:26'),
(4, 2, 'Everyday trip to Davao', 8999.99, 0, 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.', 1, '', '', '2016-10-25 22:32:30'),
(5, 3, 'Baguio City 3 days and 2 nights package', 3999, 3, 'Other details here', 1, 'Hotel', 'Van', '2016-10-29 22:43:13');
...
(1, 'Boracay', 'Boracay, Plawan', 'Summer capital of the Philipines', '1477396257_50cfe1138f170f2174db66ebbe33787e.jpg', 1),
...
--
ALTER TABLE `ref_booking_status`
  MODIFY `status_code` int(11) NOT NULL AUTO_INCREMENT;
--
