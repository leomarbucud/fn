            ...
            <div class="admin-page">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Add Airline</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php endif; endif; ?>
                        <form action="<?=$config['url']['base_path']?>/airlines.php?action=save" method="POST" data-toggle="validator" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="airline_details" name="airline_details" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
