            ...
            <div class="admin-page">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php endif; endif; ?>
                        <form action="<?=$config['url']['base_path']?>/inquiries.php?action=send_email" method="POST" data-toggle="validator" role="form">
	                        ...
	                        <table class="table" >
	                            ...
	                            <tr>
	                                <td>Subject</td>
	                                <td>
	                                	<input type="text" class="form-control" name="subject" value="Your inquiry for <?=$inquiry['place_from']?> to <?=$inquiry['place_togo']?>">
	                                </td>
	                            </tr>
	                            <tr>
	                                <td>Body</td>
	                                <td>
	                                	<textarea class="form-control" rows="10" name="body">Hi <?=$inquiry['name']?>,
